...
class DetailController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $count = 0;
        $a = [];
        // if($request->updateMode=="true"){
        //     // dd($request->all());
        //     foreach ($loop_check as $key => $value) {
        //     try{
        //     if ($lottery_data[$key] == 2) {
        //      $datas = Detail::where('client_id',$value['client_id'])->first();
