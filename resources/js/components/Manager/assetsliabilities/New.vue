  ...
  <div>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark">Add Assets/Liabilities Detail</h5>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="row">
              <div class="col-8">
                <div class="card card-primary">
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form role="form" enctype="multipart/form-data" @submit.prevent="addAssetsLiabilities()">
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="form-group col-md-12">
                          <label for="topic">Name<code>*</code></label>
                          <input type="text" class="form-control" id="topic" placeholder="Add name" v-model="form.topic" name="topic" :class="{ 'is-invalid': form.errors.has('topic') }" autocomplete="off">
  ...
  export default {
    ...
    methods:{
     addAssetsLiabilities(){
      ...
      this.form.post('/manager/assetsliabilities')
      .then((response)=>{
