    ...
    <div>
        <div class="content-header">
            <div class="container-fluid">
                <div class="row">
                <div class="col-sm-6">
                    <h5 class="m-0 text-dark">Transfer To Digital Wallet</h5>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="card-footer">
                                                            <button type="submit" class="btn btn-primary" :disabled="state.isSending">{{state.isSending ? "Loading..." : "Transfer To Wallet"}}</button>
                                                        </div>
                                                    </div>
