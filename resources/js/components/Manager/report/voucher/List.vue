  ...
  <div>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark xyz">Voucher Report</h5>
          </div><!-- /.col -->
          <div class="col-sm-6">
                      ...
                      <div v-else>  -->
                        ...
                        <tbody class="text-center" v-if="this.reportsts==false">
                          <tr v-for="(detail, index) in getAllData" :key="detail.id">
                            ...
                            <td>
                              <!-- <input type="hidden" class="form-control" name="id" v-model="detail.id"> -->
                              <span class="badge badge-primary"> Voucher{{ index + 1 }}</span>
                            </td>

                            <td>
                              {{ detail.date_np }}
                              <span class="badge badge-warning text-danger">{{ detail.created_at | formatDate }}</span>
                            </td>

                            <td>
                              <span class="text-primary">{{ detail.amt_to_be_paid }}</span>
                            </td>
                            <td>
                              <span class="text-primary">{{ detail.amount_paid }}</span>
                            </td>
                            <td>
                              <span class="text-primary">{{ (detail.amt_to_be_paid - detail.amount_paid) }}</span>
                            </td>
                            <td class="text-left">
                              
                              <router-link :to="{ name: 'voucherprint', params: { type: 'default', data: detail } }
                          ...
                          <tr v-for="(detail, index) in getAllData" :key="detail.id">
                            ...
                            <td class="text-left">
                              ...
                              <router-link :to="{ name: 'voucherprint', params: { type: 'agent',printtype:'amtbc',data: detail } }
                              " class="btn btn-xs btn-outline-info" title="Print without commision">
                                <i class="fas fa-print">

                                </i>
                              </router-link>

                                <router-link v-if="detail.amt_ac!=''" :to="{ name: 'voucherprint', params: { type: 'agent',printtype:'amtac', data: detail } }
                              " class="btn btn-xs btn-outline-success" title="Print with commision">
                                <i class="fas fa-print">
