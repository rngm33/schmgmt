<template>
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark xyz">Purchase List</h5>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card card-info card-outline">
              <div class="card-header">
                <div class="row">
                  <div class="col-md-2">
                    <router-link to="/purchase/create" class="btn btn-primary btn-block" style="color:#fff"> Add <i class="fas fa-user-plus fa-fw"></i></router-link>
                  </div>
                  <div class="col-md-10">
                  ...
                  <table class="table table-bordered table-hover table-sm m-0">
                    ...
                    <tbody class="text-center">
                      <tr v-for="(data,index) in getAllPurchase" :key="data.id" :class="colorchange(data.is_active)">
                        ...
                        <td>
                          <router-link :to="`/purchase/${data.id}/edit`" class="btn btn-xs btn-outline-info"><i class="fas fa-pencil-alt" title="Click to edit"></i></router-link> 
  ...
  import pagination from '../../../components/PaginationComponent.vue';
    ...
    computed:{
      ...
      PurchaseStatus(clkid, show){
          axios.get('/manager/purchase/status/'+clkid+'/'+show)
          .then(()=>{
      ...
      deletePurchase(id){
        ...
        Swal.fire({
          ...
          if(isConfirm.value === true) {
            axios.delete('/manager/purchase/'+id)
            .then((response)=>{
              Toast.fire({
                icon: 'success',
