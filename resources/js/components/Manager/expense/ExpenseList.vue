  ...
  <div>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark">Expense List</h5>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <section class="col-lg-12 connectedSortable">
            <!-- main page load here-->
            <button class="btn btn-primary rounded-0"><i class="fas fa-print">Print</i></button>
                    ...
                    <table class="table table-bordered table-hover table-sm m-0">
                      ...
                      <tbody>
                        <tr v-for="(data,index) in getAllTpnpReport" :key="data.id">
                          ...
                          <td>{{data.name}}</td>
                          <td class="col-md-2">
                            <router-link :to="`/kista/has/expense/${data.id}/${data.luckydraw_id}`" class="btn btn-xs btn-outline-info" title="Add Expense"><i class="fas fa-plus"></i></router-link>
                          </td>
                        </tr>
                      </tbody>
                    </table>
