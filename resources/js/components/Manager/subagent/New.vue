  ...
  <div>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark">Add Sub Agent Detail</h5>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="col-8">
                <div class="card card-primary">
                  <div class="card-header">
                    <router-link :to="'/kista/add/agent/'+this.$route.params.agentid">
                      <i class="fas fa-arrow-left" title="Click to go back"></i>
                    </router-link>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form role="form" enctype="multipart/form-data" @submit.prevent="addSubAgent()">
                    <div class="card-body">
                      <div class="row">
                        <input type="hidden" class="form-control" id="name" v-model="form.agentid" name="name">
  ...
  export default {
    ...
    methods:{
     addSubAgent(){
      ...
      this.form.post('/manager/subagent')
      .then((response)=>{
        // this.$router.push(`/agent/add/subagent/${this.$route.params.agentid}`)
