  ...
  <div>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark xyz">Detail of {{this.manager_name}}</h5>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-lg-3">
            <router-link :to="`/luckydraw/${this.$route.params.managerid}`">
          ...
          <div class="col-lg-3">
              <router-link :to="`/kista/${this.$route.params.managerid}`">
            ...
            <div class="col-lg-3">
              <router-link :to="`/agent/${this.$route.params.managerid}`">
            ...
            <div class="col-lg-3">
              <router-link :to="`/clientlist/${this.$route.params.managerid}`">
            ...
            <div class="col-lg-3">
              <router-link :to="`/incomeexpenditurelist/${this.$route.params.managerid}`">
                <div class="small-box bg-info">
                  <div class="inner">
                    <h3></h3>
            ...
            <div class="col-lg-3 col-6">
              <router-link :to="`/bankbalance/${this.$route.params.managerid}`">
                <div class="small-box bg-success">
                  <div class="inner">
                    <h3></h3>
            ...
            <div class="col-lg-3 col-6">
              <router-link :to="`/record/${this.$route.params.managerid}`">
                <div class="small-box bg-warning">
                  <div class="inner">
                    <h3></h3>
            ...
            <div class="col-lg-3 col-6">
              <router-link :to="`/purchase/${this.$route.params.managerid}`">
                <div class="small-box bg-primary">
                  <div class="inner">
                    <h3></h3>
